...
| Sanità: valori reali, demografia, outcome | Conto economico e serie storica su `main`. Demografia e outcome assenti | Dipende | Alto | PR [#207](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/207) aperta: grafico contabile, **non mergiare** finché il test browser in CI va in timeout. Non copre demografia/outcome | `/spese/sanita`, `/spese/sanita/storico` | Deflatore dichiarato, popolazione/anziani, un outcome ufficiale in verticale pilota. Feedback: X-009, X-021, X-022, X-035, A-003. |
...
|---|---|---|
| [#207](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/207) grafico sanità | Aperta | Non usarla come veicolo per demografia/outcome. Sbloccarla solo dopo il timeout del browser test. |
