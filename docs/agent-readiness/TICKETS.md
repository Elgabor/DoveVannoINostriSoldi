...
Documento di stato mantenuto sul fork. Ticket 01–08 completati; ticket 08 ha superato review indipendente (correzioni discoverability `65c43490`+`5b22692`, W1/W2/W3 PASS, A/B NOT_RUN). La PR unica #8 ora riunisce i due filoni e ha HEAD `f4f96a9e` verso `main` del fork. Esecuzione sequenziale; un ticket per sessione, seguito da review indipendente. Specifica: [SPEC.md](SPEC.md).
