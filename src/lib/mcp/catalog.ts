...
const datasetDescriptors: DatasetDescriptorInput[] = [
  { id: "siope_comuni", title: "Pagamenti dei Comuni", summary: "Pagamenti di cassa SIOPE, serie mensile, titoli, regioni e principali Comuni.", sourceIds: ["siope", "ipa"], freshness: "snapshot", filters: ["year", "region"], caveat: "Gli aggregati regionali coprono tutti i Comuni abbinati; le liste comunali contengono soltanto i primi 100 nazionali per totale o pro capite. Il campo distribution contiene solo aggregati completi calcolati durante un refresh raw verificato; non autorizza a ricostruire quartili dai primi 100." },
